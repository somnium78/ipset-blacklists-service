...
fetch https://github.com/somnium78/ipset-blacklists-service/releases/latest/download/ipset-blacklists-opnsense-2.0.8-opnsense.tar.gz
2. **Extract and install:**
tar -xzf ipset-blacklists-opnsense-2.0.8-opnsense.tar.gz
cd ipset-blacklists-opnsense-2.0.8-opnsense
