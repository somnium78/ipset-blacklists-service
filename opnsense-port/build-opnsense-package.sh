...
sed "s/VERSION=\"2\.0\.11-opnsense\"/VERSION=\"${VERSION}\"/" bin/ipset-blacklist-opnsense > "$PACKAGE_DIR/bin/ipset-blacklist-opnsense"
...
sed -i "s/echo \"2\.0\.11-opnsense\"/echo \"${VERSION}\"/" "$PACKAGE_DIR/scripts/install-opnsense.sh"
